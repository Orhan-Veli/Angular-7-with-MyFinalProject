...
export class ProductComponent implements OnInit {
  ...
  product3: any = { productId: 3, productName: 'Mouse', categoryId: 3, unitPrice: 5 }
  product4: any = { productId: 4, productName: 'Keyboard', categoryId: 4, unitPrice: 5 }
  product5: any = { productId: 5, productName: 'Camera', categoryId: 5, unitPrice: 5 }
